...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～08 已完成工程基线、内容与地图 pilot、事务 World 替换和迁移清单；Phase 09 已新增独立 V2 状态 envelope，使用稳定 map/spawn ID 和 section versions，尚未替换 V1 文件格式。
