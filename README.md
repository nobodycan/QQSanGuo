...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～02 已完成基础工具链、资源闭包与测试编排；Phase 03 正在冻结六个目标 Autoload，并通过静态门禁阻止新增 legacy 全局依赖。
