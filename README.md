...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～04 已完成工程基线、全局边界和内容 pilot；Phase 05 已加入兼容式 `GameRoot` 组合根及生命周期回归测试，尚未迁移旧地图内嵌节点。
