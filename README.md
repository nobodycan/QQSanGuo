...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～12 已完成工程基线、V2 存档/迁移基础与音频设置边界。Phase 13 Foundation Gate 已审计，但被 legacy Godot 退出资源泄漏阻断；详见 `docs/superpowers/phase13-foundation-gate-audit.md`。
