...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～05 已完成工程基线、内容 pilot 与兼容式 `GameRoot`；Phase 06 已提供候选 World 的显式事务替换 API 和回滚回归测试，legacy 场景切换尚待后续迁移。
