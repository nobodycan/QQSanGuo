...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～16 已完成工程基线、V2 存档/迁移基础、音频设置边界、Foundation Gate、PlayerIntent/PlayerStats，以及 Vitals 状态机与遗留生命值适配；Phase 17 已建立稳定 Actor ID、阵营与目标选择基础；Phase 18 已建立确定性 DamagePipeline 基础。完整 Gate 已在 Godot `3.5.3` 下通过。
