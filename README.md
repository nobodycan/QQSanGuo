...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～06 已完成工程基线、内容 pilot、兼容 `GameRoot` 和事务 World 替换；Phase 07 已为两张 pilot 地图定义稳定 map/spawn/portal ID，并由内容审计验证引用闭包。
