...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～09 已完成工程基线、地图 pilot、事务 World 替换与 V2 state envelope；Phase 10 已新增隔离的 `save_a/save_b` 双世代读写与回退验证，V1 文件格式仍保持兼容。
