...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～03 已完成工程基线、测试编排和全局边界；Phase 04 已建立 ContentRegistry pilot pack，并在资源通道校验稳定 ID 与资源引用。
