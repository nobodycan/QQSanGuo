...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～11 已完成工程基线、V2 存档/迁移基础与内容地图 pilot；Phase 12 已提供独立 `settings.cfg` 音频设置读写边界，常驻 UI 和启动路由仍待迁移。
