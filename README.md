...
The inventory foundation now includes a versioned 50-slot state with deterministic stack insertion, capacity-safe failure handling, slot movement, stack splitting, and quest-safe consumption.
