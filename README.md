...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～14 已完成工程基线、V2 存档/迁移基础、音频设置边界、Foundation Gate，以及统一 PlayerIntent、移动和动画适配；Phase 15 已建立 versioned PlayerStats、1～30 XP 表、V2 迁移与旧属性适配边界。完整 Gate 已在 Godot `3.5.3` 下通过。
