...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～07 已完成工程基线、内容 pilot、事务 World 替换和 pilot 地图定义；Phase 08 已记录所有候选地图的嵌入式 Player/UI 与直接切场景迁移基线，拆除工作将按地图逐步进行。
