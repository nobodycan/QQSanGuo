...
项目按 [V1 路线图](docs/superpowers/plans/2026-07-20-qqsanguo-v1-roadmap.md) 分阶段推进。Phase 00～10 已完成工程基线、地图 pilot、V2 state envelope 和双世代存档基础；Phase 11 已定义 V1 路径/中文内容名到稳定 ID 的 alias 映射，未知值会明确拒绝而非静默丢失。
