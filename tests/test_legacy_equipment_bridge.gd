...
func _init():
	...
	test.expect(bridge.enhance("Sword") and bridge.project_presenter().Sword.enhancement_level == 1 and bridge.project_presenter().Sword.power_score == 25, "projects an independently enhanced legacy equipment instance")
